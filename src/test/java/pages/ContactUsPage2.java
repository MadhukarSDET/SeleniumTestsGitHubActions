...
public class ContactUsPage2 extends Page {

	public ContactUsPage2(WebDriver driver) {
		super(driver);
	}
	...
	private ContactUsPage2 enterName(String name) {
		nameTextBox.sendKeys(name);
		return this;
	}

	private ContactUsPage2 enterEmail(String email) {
		emailTextBox.sendKeys(email);
		return this;
	}

	private ContactUsPage2 enterSubject(String subject) {
	...
	private ContactUsPage2 clickSubmit() {
